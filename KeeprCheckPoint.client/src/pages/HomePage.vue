<template>
  ...
  <button class="btn btn-outline-success button1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
    Create a Keep <i class="mdi mdi-plus" ></i>
  </button>

  <button class="btn btn-outline-success button1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Create a Vault  <i class="mdi mdi-plus" ></i></button>
        ...
        <div v-if="keep">
          ...
          <div  class="modal-header">
            ...
            <div class="modal-body row">
              <div class="col-6"> <img class="img-fluid modal-img" :src="keep.img" alt=""> <button type="button" data-bs-dismiss="modal" @click="deleteKeep(keep.id)" class="modal-button-trash btn btn-outline-danger" ><i class="mdi mdi-trash-can-outline" ></i></button> </div>
              <div class="col-6">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header header1">
      ...
      <button type="button" class="btn btn-outline-danger button1" data-bs-dismiss="offcanvas" aria-label="Close"><i class="mdi mdi-close-box-multiple-outline"></i></button>
    </div>
   ...
   <form @submit.prevent="createVault()">
              <div>
                ...
                <div>
                  <input v-model="editable.Description" required type="text" class="form-control" id="Description" maxlength="500" >
               ...
               <div class="form-check mt-4">
                ...
                <button class="mt-4 col-12 btn btn-outline-success"> create Vault <i class="mdi mdi-plus" ></i> </button>
   ...
   <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        <div class="offcanvas-header header1">
          ...
          <button type="button" class="button1 btn btn-outline-danger" data-bs-dismiss="offcanvas" aria-label="Close"><i class="mdi mdi-close-box-multiple-outline"></i></button>
        </div>
        <div class="offcanvas-body">
          <div>
    ...
    return {
      ...
      async createVault(){
        try {
          ...
          const Vault = await vaultsServices.createVault(formData)
          // ref = {}
        } catch (error) {
          Pop.error(error.message)
        }
